...
## ✨ Project Overview
“북적북적”은 도서를 쉽고 빠르게 확인·거래할 수 있는 풀스택 전자상거래 플랫폼입니다.

- **Live Demo**: [`http://52.79.159.149/`](http://52.79.159.149/)  
  📱 *모바일에서는 https로 자동 전환될 수 있습니다. 주소를 복사해 브라우저에 직접 입력해 주세요.*

- **Swagger UI**: [`http://52.79.159.149:8080/swagger-ui/index.html`](http://52.79.159.149:8080/swagger-ui/index.html)  
  📱 *모바일 접속 시 링크가 열리지 않으면 주소를 복사해 수동으로 입력하세요.*
