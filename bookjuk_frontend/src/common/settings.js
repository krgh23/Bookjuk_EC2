...
export function getHost() {
  return window.location.origin; // http://52.79.159.149 or http://52.79.159.149:8080
}

/* 프로젝트 ContextPath 구하기 */
export function getContextPath() {
  const url = window.window.location.href; // http://52.79.159.149:8080/myapp/main.do
  const host = window.location.host; // 52.79.159.149:8080
