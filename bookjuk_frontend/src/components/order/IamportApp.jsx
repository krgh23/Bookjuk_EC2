...
import { completePayment } from "../../api/portOneAPI";
...
export function IamportApp({
  ...
  , String paymentId*/
    ...
    if (paymentMethod === "kakao") {
      ...
      console.log("============ paymentMethod kakao : " + payment + "===============")
    ...
    // 결제 완료 후, completePayment 함수를 통해 서버에 상태 전달
    try {
      const paymentComplete = await completePayment(payment.paymentId);
      setPaymentStatus({
